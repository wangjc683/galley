export const zhCopy = {
  ...
  composer: {
    ...
    goalConfirmBody:
      "Galley 会一轮一轮自己推进，直到判断目标完成或到达时间上限。中途你随时可以发消息引导，或停止。",
    goalConfirmObjective: "目标",
    goalConfirmCeiling: "时间上限（分钟）",
    goalDurationOption: (minutes: number) => `${minutes} 分钟`,
    goalDurationRecommendedTip: (minutes: number) => `${minutes} 分钟 · 推荐`,
    goalDurationNoCeiling: "无上限",
    goalDurationCustom: "自定义",
    goalCustomMinutesLabel: "自定义时间上限（分钟）",
    goalCustomMinutesPlaceholder: "分钟",
    goalCustomMinutesHint: (minutes: number) => `最少 ${minutes} 分钟`,
    goalNoCeilingHint: "不设上限，直到 Galley 判断完成或你停止。",
