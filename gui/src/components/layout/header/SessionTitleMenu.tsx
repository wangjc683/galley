      ...
      <DropdownMenu.Trigger asChild>
        <button
          ...
          className={cn(
            ...
            "transition-none active:transition-[transform,box-shadow] active:duration-(--motion-press) active:ease-firm hover:bg-hover data-[state=open]:bg-hover active:translate-y-px",
