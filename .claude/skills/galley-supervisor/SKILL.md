...
1. **Identity.** Your supervisor id is `claude-skill-galley-supervisor/v1`.
   Pass `--supervisor=claude-skill-galley-supervisor/v1` plus a truthful
...
- [ ] Did I pass `--supervisor=claude-skill-galley-supervisor/v1` and `--reason=`?
